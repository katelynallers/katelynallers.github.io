...
<head>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<section id="header">
				<header>
					<span class="image avatar"><img src="images/allers_avatar.png" alt="" /></span>
					<h1 id="logo"><a href="#">Dr. Katelyn N. Allers</a></h1>
					<!--<p>Professor of Physics and Astronomy<br />
					...
					<!--	<li><a href="cv.pdf" class="button scrolly" align="center">Curriculum Vitae</a></li> -->
						...
						<!-- Two -->
							<section id="two">
								<div class="container">
									<h3>Skills</h3>
									<p>My background as an astronomer and university professor has given me a broad range of research, management, and communication skills. </p>
								  <ul class="feature-icons">
								                <li class="icon solid fa-chart-bar">Data analysis, statistical modeling, graphical data presentation, experimental design</li>
							...
							<section id="three">
								<div class="container">
									...
									<div class="features">
										...
										<article>
											<a href="#" class="image"><img src="images/windspeed.jpg" alt="" /></a>
											<div class="inner">
												<h4>The first measurement of windspeed on a brown dwarf</h4>
												<p>We compared measurements of the rotation speed of a brown dwarf at radio and infrared wavelengths to measure a whopping windspeed of 650 m/s (or 1425 mph)!  Our observations with the Very Large Array and NASA's Spitzer Space Telescope verified that this technique can work to measure atmospheric winds not only on brown dwarfs, but also on extrasolar planets in the future. </p>
											  <li><a href="https://ui.adsabs.harvard.edu/abs/2020Sci...368..169A/abstract">Publication</a></li>
	  <li><a href="https://public.nrao.edu/news/brown-dwarf-wind-speed/#:~:text=Just%20as%20with%20Jupiter%2C%20they,wind%20speed%2C%20about%20230%20mph.">Press</a> <a href="https://www.jpl.nasa.gov/news/in-a-first-nasa-measures-wind-speed-on-a-brown-dwarf">Releases</a>										  </div>
										</article>
										<article>
											<a href="#" class="image"><img src="images/arcoiris.jpg" alt="" /></a>
											<div class="inner">
												<h4>Data Reduction Software for TripleSpec 4.1</h4>
											  <p>I wrote the module for the facility data reduction package for the <a href="http://www.ctio.noao.edu/soar/content/triplespec-41">TripleSpec4.1</a> spectrograph on the Blanco and SOAR Telescopes.</p>
											  <li><a href="https://ui.adsabs.harvard.edu/abs/2020SPIE11447E..6LH/abstract">Publication</a></li>
											  <li><a href="https://www.dropbox.com/home/ARCoIRIS_Software">Package Download (requires IDL)</a></li>
											  <li><a href="https://www.youtube.com/playlist?list=PLxY2tf8cmN8Qep9tOgn_OWritFsTmkNyJ"> Video Example of Reduction </a></li>
											</div>
										</article>
									</div>
								</div>
